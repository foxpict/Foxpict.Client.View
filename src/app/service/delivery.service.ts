...
import { UpdateCategoryListParam } from "../shared/infra/UpdateCategoryListParam";
...
export class DeliveryService {
  ...
  public updateContent(content: Content) {
    console.info("[Foxpict][Delivery][updateContent] IN");
    var intentMessage = new IntentMessage();
    intentMessage.ServiceType = "Workflow";
    ...
    this.send(intentMessage);
    console.info("[Foxpict][Delivery][updateContent] OUT");
  }
  ...
  public updateContentList(param: UpdateContentListParam) {
    ...
    // TODO: 他のルールも追加する
    console.info("[Foxpict][Delivery][updateContentList] ", param);
  ...
  public updateCategoryList(param: UpdateCategoryListParam) {
    console.info("[Foxpict][Delivery][updateCategoryList] ", param);
